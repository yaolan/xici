package net.xici.newapp.support.widget.materialdesign.views;

import net.xici.newapp.R;
import net.xici.newapp.support.widget.materialdesign.utils.Utils;
...
public class ButtonRectangle extends Button {
	...
	protected void setAttributes(AttributeSet attrs) {
		...
		int textColorRes = attrs.getAttributeResourceValue(ANDROIDXML,
				"textColor", -1);
		if (textColorRes != -1) {
			textColor = getResources().getColor(textColorRes);
		} else {
			// Color by hexadecimal
			String textColorStr = attrs.getAttributeValue(ANDROIDXML,
					"textColor");
